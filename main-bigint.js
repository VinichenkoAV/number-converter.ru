...
function converterBigInt(user_value) {
  ...
  if (!_typewriter_bigint_js__WEBPACK_IMPORTED_MODULE_0__["TypewriterBigint"].checkUserBigInt(user_value)) {
    return false;
  } // Основной код функции.


  return "".concat(new _typewriter_bigint_js__WEBPACK_IMPORTED_MODULE_0__["TypewriterBigint"](user_value));
}
...
form2.addEventListener("submit", function (event) {
  ...
  if (!resultBigNum) {
    ...
    document.getElementById("resultBigint").innerText = resultBigNum; //window.requestAnimationFrame(printResult3);
  }
...
/*!**************************************!*\
  !*** ./scripts/typewriter-bigint.js ***!
  \**************************************/
/*! exports provided: TypewriterBigint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TypewriterBigint", function() { return TypewriterBigint; });
...
}(_typewriter_sum_js__WEBPACK_IMPORTED_MODULE_0__["TypewriterSum"]);
