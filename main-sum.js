...
function converterSum(user_value, currency, statusVAT) {
  ...
  if (!_typewriter_sum_js__WEBPACK_IMPORTED_MODULE_0__["default"].checkUserSum(currency, user_value)) {
    return false;
  ...
  if (statusVAT === "1") {
    ...
    amount = _construct(_typewriter_sum_js__WEBPACK_IMPORTED_MODULE_0__["default"], [currency].concat(_toConsumableArray(user_value.split("."))));
  } else {
    // Начисление НДС
    VAT = user_value * 0.2;
  ...
  amountVAT = _construct(_typewriter_sum_js__WEBPACK_IMPORTED_MODULE_0__["default"], [currency].concat(_toConsumableArray(VAT.split(".")))); // Возвращение результата в текстовом оформлении суммы.
